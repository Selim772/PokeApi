...
export default new Vuex.Store({
    state: {
        pokemonList: [
            ...
            {number: 29, name: 'Nidoran', alias: 'nidoran-f'},
            {number: 30, name: 'Nidorina'},
            {number: 31, name: 'Nidoqueen'},
            {number: 32, name: 'Nidoran', alias: 'nidoran-m'},
            ...
            {number: 83, name: 'Farfetch\'d', alias: 'farfetchd'},
            ...
            {number: 122, name: 'Mr. Mime', alias: 'mr-mime'},
    ...
    mutations: {
        updatePokemonDetails(state, data) {
            ...
            pokemon.abilities = data.details.abilities;
        }
    },
    actions: {
